...
It is very recommended to migrate `vite-pages-theme-basic` to [vite-pages-theme-doc2](/official-theme).
...
We also recommend you to migrate `vite-pages-theme-basic` to [vite-pages-theme-doc2](/official-theme) with this setup (with vite v2).
