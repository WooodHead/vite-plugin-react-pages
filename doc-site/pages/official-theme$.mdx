...
`vite-pages-theme-doc2` is an official theme of vite-pages. It should satisfy most users' needs. This document site is powered by this theme.
...
The `createTheme` exported by `vite-pages-theme-doc2` accepts [these options](https://github.com/vitejs/vite-plugin-react-pages/blob/main/packages/theme-doc/src/index.tsx):
