...
i18n support can be provided by theme. For example, [the official theme(vite-pages-theme-doc2)](/official-theme) support i18n. This document shows how to create a multi-lingual site with it.

## Define i18n metadata in the theme config

The [the official theme(vite-pages-theme-doc2)](/official-theme) accepts 1i8n config like this:

```tsx
import { createTheme } from 'vite-pages-theme-doc2'
...
```ts
import { createTheme } from 'vite-pages-theme-doc2'
import type { MenuConfig } from 'vite-pages-theme-doc2'
...
import { useThemeCtx } from 'vite-pages-theme-doc2'
